...
public class SGIPMsgFactory {
    ...
    public List<SGIPSubmitMessage> buildSGIPSubmitMessage(String src, String[] dest,
        ...
        if (msg_Fmt == 15) {
            ...
            if (bytesList.size() == 1) {
                fillMsg(msgs, list, bytesList, 0, msg_Fmt, src, feeType, feeValue, priority, params);
            } else {
                fillMsg(msgs, list, bytesList, 1, msg_Fmt, src, feeType, feeValue, priority, params);
            }
        } else {
        ...
        if (msg_Fmt == 15) {
            ...
            if (bytesList.size() == 1) {
                fillMsg(corpId, msgs, list, bytesList, 0, msg_Fmt, src, feeType,
                    String.valueOf(feeValue), priority);
            } else {
