...
public class SMGP3MsgFactory {
    ...
    public List<SMGP3SubmitMessage> buildSMGP3SubmitMessage(String src, String[] dest,
        ...
        if (msg_Fmt == 15) {
            ...
            if (bytesList.size() == 1) {
                fillMsg(msgs, list, bytesList, 0, msg_Fmt, src, feeType, feeCode, priority, params);
            } else {
                fillMsg(msgs, list, bytesList, 1, msg_Fmt, src, feeType, feeCode, priority, params);
            }
        } else {
    ...
    public List<SMGP3SubmitMessage> buildSMGP3SubmitMessage(String src, String[] dest,
        ...
        if (bytesList.size() == 1) {
            fillMsg(msgs, list, bytesList, 0, msg_Fmt, src, feeType, fee, priority, null);
        } else {
            fillMsg(msgs, list, bytesList, 1, msg_Fmt, src, feeType, fee, priority, null);
        }
        //        } else {
        //            byte[] msg = PMessage.getMsgContent(msgContent, msg_Fmt);
        //            if (msg.length > 160) {
    ...
    public void fillMsg(List<SMGP3SubmitMessage> msgs, List<String[]> users,
                        ...
                        String feeType, String fee, int priority, Map<String, String> params)
