$(document).ready(function(){
  ...
  var loadGrid = function(){
	  var p = $('#admin-pub-table').datagrid({
	        toolbar: [
	        {
				iconCls: 'icon-edit',
				text: '编辑',
			...
			checkOnSelect:true,
			selectOnCheck:true,
			url:currenthost+'/admin/loadPub.json',
			columns:[[
			    {field: 'id',checkbox: true},
				{field:'title',title:'标题',width:100},
				{field:'content',title:'内容',width:100},
				{field:'price',title:'价格',width:100},
				{field:'contactUser',title:'联系人',width:150},
				{field:'contactInfo',title:'联系电话',width:50},
	...
	var editRows = function(){
        ...
        var rows = $("#admin-pub-table").datagrid('getSelections');
        if (rows.length != 1 ) {
            ...
            $.messager.alert('提示','请至少选中一条记录');  
				...
				function(r) {
					if (r) {
						...
						jQuery.ajax({
							url: currenthost + '/admin/delPub.json',
							data: {
								id: ids
							},
							dataType: 'json',
