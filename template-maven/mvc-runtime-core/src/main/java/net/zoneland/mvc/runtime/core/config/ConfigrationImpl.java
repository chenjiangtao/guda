 ...
 */
package net.zoneland.mvc.runtime.core.config;
...
public class ConfigrationImpl implements Configration {
    ...
    /** 
     * @see net.zoneland.mvc.runtime.core.config.Configration#getAppName()
     */
    ...
    /** 
     * @see net.zoneland.mvc.runtime.core.config.Configration#getConfig()
     */
    ...
    /** 
     * @see net.zoneland.mvc.runtime.core.config.Configration#getPropertyValue(java.lang.String)
     */
    ...
    /** 
     * @see net.zoneland.mvc.runtime.core.config.Configration#getRunMode()
     */
    ...
    /** 
     * @see net.zoneland.mvc.runtime.core.config.Configration#getAppRoot()
     */
