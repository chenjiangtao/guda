...
public class AppConfigLocation {
    ...
    public static final String default_props_location_linux = "/zoneland/" + default_props;
    public static final String default_props_location_win   = System.getProperty("user.home")
                                                              + File.separator + default_props;
