 ...
 */
package com.tiaotiaogift.ada.common.dal.page;
...
public class Page {
    ...
    public Page(int pageId, int total, Collection<?> result) {
        if (total > 0) {
            this.pageId = pageId;
            this.total = total;
            this.result = result;
    ...
    public Page(int pageId, int total, Collection<?> result,int pageSize) {
