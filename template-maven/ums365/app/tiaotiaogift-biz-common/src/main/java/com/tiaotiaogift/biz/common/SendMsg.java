 ...
 * 
 * @author gag
 * @version $Id: SendMsg.java, v 0.1 2012-12-18 上午10:25:07 gag Exp $
 */
public class SendMsg {

    public static void main(String args[]) {
        Modem Mytest = new Modem(); //创建一个 mondem 对象， 这个对象最大可以支持64个端口发送
        int rc;
        ...
        if ((rc = (Mytest.InitModem(-1))) == 0)//初始化短信猫
        {
            ...
            //--------普通短信测试-------------
            rc = Mytest.SendMsg(-1, "13588754574", "测试信息，恭喜发财!"); //发送一条信息,从可以使用的任意端口
