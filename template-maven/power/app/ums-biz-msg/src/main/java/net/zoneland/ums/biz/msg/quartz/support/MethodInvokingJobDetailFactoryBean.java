 ...
 */
public class MethodInvokingJobDetailFactoryBean implements FactoryBean<Object>, BeanNameAware,
                                               InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        try {
            ...
            logger.info("Created JobDetail: " + jobDetail + "; targetClass: " + targetClass
                        + "; targetObject: " + targetObject + "; targetMethod: " + targetMethod
                        + "; staticMethod: " + staticMethod + "; arguments: " + arguments + ";");
        } finally {
            logger.debug("end");
        }
    }
