...
public class SchedulerFactoryBean extends SchedulerAccessor implements FactoryBean<Scheduler>,
    ...
    public void setSchedulerFactoryClass(Class<?> schedulerFactoryClass) {
        if (schedulerFactoryClass == null
            || !SchedulerFactory.class.isAssignableFrom(schedulerFactoryClass)) {
        ...
        try {
            ...
            if (this.jobFactory != null) {
                if (this.jobFactory instanceof SchedulerContextAware) {
                    ((SchedulerContextAware) this.jobFactory).setSchedulerContext(this.scheduler
                        .getContext());
                }
     ...
     */
    private void initSchedulerFactory(SchedulerFactory schedulerFactory) throws SchedulerException,
                                                                        IOException {
    ...
    protected Scheduler createScheduler(SchedulerFactory schedulerFactory, String schedulerName)
        ...
        boolean overrideClassLoader = (this.resourceLoader != null && !this.resourceLoader
            .getClassLoader().equals(threadContextClassLoader));
    ...
    private void populateSchedulerContext() throws SchedulerException {
        ...
        if (this.applicationContextSchedulerContextKey == null) {
            this.applicationContextSchedulerContextKey = "applicationContext";
        }
        this.scheduler.getContext().put(this.applicationContextSchedulerContextKey,
        ...
        if (startupDelay <= 0) {
            ...
            Thread schedulerThread = new Thread() {
                ...
                public void run() {
                    ...
                    if (logger.isInfoEnabled()) {
                        logger.info("Starting Quartz Scheduler now, after delay of " + startupDelay
                                    + " seconds");
                    }
                    try {
                        scheduler.start();
