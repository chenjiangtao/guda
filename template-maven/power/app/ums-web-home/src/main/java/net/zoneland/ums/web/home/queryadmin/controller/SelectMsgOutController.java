...
import net.zoneland.ums.biz.config.queryadmin.SelectMsgOutBiz;
 ...
 * 
 * @author yangjuanying
 * @version $Id: SelectMsgOutController.java, v 0.1 2012-12-11 下午7:28:48 yangjuanying Exp $
 */
@Controller
public class SelectMsgOutController {

    private static final Logger logger = Logger.getLogger(SelectMsgOutController.class);

    @Autowired
    private SelectMsgOutBiz     selectMsgOutBiz;
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/queryAdmin/selectMsgOutInit.htm")
    public String doGet(AppMsgInfoForm form, ModelMap modelMap) throws Exception {
        ...
        return "/queryAdmin/selectMsgOut.vm";
    }

    /**
     * 拦截条件查询【短信查询用户短信】的get和post请求
     * 
     * @param form
     * @param request
     * @param response
     ...
     * @throws Exception
     */
    @RequestMapping(value = "/queryAdmin/selectMsgOut.htm")
    public String doPost(AppMsgInfoForm form, HttpServletRequest request,
        ...
        try {
            result = selectMsgOutBiz.selectStatMsgOut(appMsgInfoBO, pageId);
        } catch (Exception e) {
            logger.error("短信查询【用户短信】出现异常：", e);
        }
     ...
     * @return
     */
    @RequestMapping("/queryAdmin/selectMsgOutDetail.htm")
    public String selectMsgOutDetail(AppMsgInfoForm form, ModelMap modelMap,
        ...
        modelMap.addAttribute("msg", form);
        return "queryAdmin/selectMsgOutDetail.vm";
    }
