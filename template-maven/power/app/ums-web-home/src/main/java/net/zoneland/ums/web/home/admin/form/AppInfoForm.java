...
public class AppInfoForm {
    ...
    @Size(max = 30, message = "应用名称不能超过30位")
    ...
    /**
     * Getter method for property <tt>isOutProv</tt>.
     * 
     * @return property value of isOutProv
     */
    ...
    public void setIsOutProv(String isOutProv) {
        this.isOutProv = isOutProv == null ? "" : isOutProv.trim();
    }
