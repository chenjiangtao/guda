 ...
 * 
 * @author gag
 * @version $Id: InOk.java, v 0.1 2012-11-22 下午1:42:24 gag Exp $
 */
public class InOk {
    ...
    public InOk(InReady in) {
        this.ack = in.getAck();
        this.appid = in.getAppid();
        this.appserialno = in.getAppserialno();
        this.batchno = in.getBatchno();
        this.content = in.getContent();
        this.docount = in.getDocount();
        this.errmsg = in.getErrmsg();
        this.finishtime = in.getFinishtime();
        this.mediaid = in.getMediaid();
        this.msgtype = in.getMsgtype();
        this.recvid = in.getRecvid();
        this.reply = in.getReply();
        this.retcode = in.getRetcode();
        this.sendid = in.getSendid();
        this.sequenceno = in.getSequenceno();
        this.serialno = in.getSerialno();
        this.subapp = in.getSubapp();
        this.submittime = in.getSubmittime();
    }
