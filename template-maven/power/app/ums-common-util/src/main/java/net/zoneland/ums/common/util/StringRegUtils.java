...
public class StringRegUtils {
    ...
    public static String  regExp         = "^[1][0-9]{2}[0-9]{8}$";
    public static String  regExpMobile   = "^[1]([3][4-9]|[4][7]|[5][0-2]|[5][7-9]|[8][2-3]|[8][7-8])[0-9]{8}$"; //匹配移动手机用户的正则表达式
    public static String  regExpUnicom   = "^[1]([3][0-2]|[4][5]|[5][5-6]|[8][5-6])[0-9]{8}$";                  //匹配联通手机用户的正则表达式
    public static String  regExpTelecom  = "^[1]([3][3]|[5][3]|[8][0]|[8][9]|[8][1])[0-9]{8}$";                 //匹配电信手机用户的正则表达式
    public static String  regExpNumber   = "^[0-9]+$";
    ...
    public static void main(String argsp[]) {
        System.out.println(isPhoneNumber("13804852698"));
